jQuery(
    function ($) {
        ...
        $('.accordion-toggle').on(
            'click', function () {
                $(this).closest('.panel-group').children().each(
                    function () {
...
function creer_un_compte()
{
    $('.alert-danger').remove();

    var str = $("#sigup-form").serialize();
    //alert(str);
    $("#submit_creer_un_compte").hide();
    $("#loading_creer_un_compte").show();
    $.ajax(
        {
