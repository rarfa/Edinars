        ...
        "thomaskahn.smoothDivScroll", {
            ...
            _create: function () {
                ...
                *****************************************/
                ...
                el.data("scrollingHotSpotRight").bind(
                ...
                el.data("scrollingHotSpotRight").bind(
                    "mouseover", function () {
                        ...
                        el.data(
                            "rightScrollingInterval", setInterval(
                                function () {
                ...
                *****************************************/
                ...
                el.data("scrollingHotSpotLeft").bind(
                    "mousemove", function (e) {
                ...
                el.data("scrollingHotSpotLeft").bind(
                    "mouseover", function () {
                        ...
                        el.data(
                            "leftScrollingInterval", setInterval(
                                function () {
                                    if (el.data("scrollXPos") > 0 && el.data("enabled")) {
                                        el.data("scrollWrapper").scrollLeft(el.data("scrollWrapper").scrollLeft() - (el.data("scrollXPos") * el.data("speedBooster")));
                ...
                *****************************************/
                el.data("scrollableArea").mousewheel(
                ...
                if (o.mousewheelScrolling) {
                    el.data("scrollingHotSpotLeft").add(el.data("scrollingHotSpotRight")).mousewheel(
                        function (event, delta) {
                              event.preventDefault();
                        }
                    );
                    ...
                    function () {
                        ...
                        if (o.autoScrollingMode !== "always") {
                            ...
                            case "onstart":
                                self.showHotSpotBackgrounds();
                                el.data(
                                    "hideHotSpotBackgroundsInterval", setTimeout(
                                        function () {
            ...
            hideHotSpotBackgrounds: function (fadeSpeed) {
                ...
                if (fadeSpeed !== undefined) {
                    ...
                    el.data("scrollingHotSpotLeft").fadeTo(
                        fadeSpeed, 0.0, function () {
                            el.data("scrollingHotSpotLeft").removeClass("scrollingHotSpotLeftVisible");
                        }
                    );

                    // Fade out the right hotspot
                    el.data("scrollingHotSpotRight").fadeTo(
                        fadeSpeed, 0.0, function () {
            ...
            move: function (pixels) {
                ...
                if ((pixels < 0 && el.data("scrollWrapper").scrollLeft() > 0) || (pixels > 0 && el.data("scrollableAreaWidth") > (el.data("scrollWrapper").innerWidth() + el.data("scrollWrapper").scrollLeft()))) {
                    if (o.easingAfterMouseWheelScrolling) {
                            el.data("scrollWrapper").animate(
                                { scrollLeft: el.data("scrollWrapper").scrollLeft() + pixels }, { duration: o.easingAfterMouseWheelScrollingDuration, easing: o.easingAfterMouseWheelFunction, complete: function () {
                                    self._showHideHotSpots();
                                    if (o.manualContinuousScrolling) {
                                        if (pixels > 0) {
                                             self._checkContinuousSwapRight();
            ...
            recalculateScrollableArea: function () {
                ...
                el.data("scrollableArea").children(o.countOnlyClass).each(
                    function () {
