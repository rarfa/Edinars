(function () {
    ...
    d3.json = function (url, callback) {
        d3.text(
            url, "application/json", function (text) {
    ...
    d3_selectionPrototype.text = function (value) {
        return arguments.length < 1 ? this.node().textContent : this.each(
    ...
    d3_selectionPrototype.html = function (value) {
        return arguments.length < 1 ? this.node().innerHTML : this.each(
            typeof value === "function" ? function () {
                var v = value.apply(this, arguments);
    ...
    d3.behavior.drag = function () {
        ...
        function mousedown()
        {
            function point()
            {
                ...
                return touchId ? d3.touches(p).filter(
                    function (p) {
        ...
        var clipType = d3_geo_type(
            {
                ...
                MultiLineString: function (o) {
                    var coordinates = o.coordinates.map(clip).filter(
                        function (d) {
                            return d.length;
                        }
                    );
