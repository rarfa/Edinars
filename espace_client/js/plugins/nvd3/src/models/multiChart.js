nv.models.multiChart = function () {
    ...
    function chart(selection)
    {
        selection.each(
            function (data) {
                ...
                x   .domain(
                    d3.extent(
                        d3.merge(series1.concat(series2)), function (d) {
                            return d.x }
                    )
                )
                ...
                var extraValue1 = dataStack1.length ? dataStack1.map(
                    function (a) {
                        return a.values}
                ).reduce(
                    function (a,b) {
                ...
                var extraValue2 = dataStack2.length ? dataStack2.map(
                    function (a) {
                        return a.values}
                ).reduce(
                    function (a,b) {
                ...
                yScale1 .domain(
                    yDomain1 || d3.extent(
                        d3.merge(series1).concat(extraValue1), function (d) {
                            return d.y }
                    )
                )
                ...
                yScale2 .domain(
                    yDomain2 || d3.extent(
                        d3.merge(series2).concat(extraValue2), function (d) {
                            return d.y }
                    )
                )
                  .range([0, availableHeight])
    ...
    lines1.dispatch.on(
        'elementMouseover.tooltip', function (e) {
    ...
    lines1.dispatch.on(
        'elementMouseout.tooltip', function (e) {
