    ...
    function chart(selection)
    {
        selection.each(
            function (data) {
                ...
                if (!data || !data.length || !data.filter(
                    function (d) {
