...
function get_user_notifications(callback){
	...
	$.ajax({
      ...
      process_get_user_notifications(reponse, function(){
...
function refresh_user_datas(callback=null){
	...
	$.ajax({
	  ...
	  success: function(reponse){
			user_datas = reponse;
			process_refresh_user_datas(reponse, function(){
				if(typeof callback === "function"){
					callback();
				}
			});
  ...
  $.ajax({
    ...
    success: function(reponse){
      ...
      $("#div_show_transaction_form").show();
    	...
    	load_form("show_transaction",function(){
  ...
  $.ajax({
    ...
    success: function(reponse){
      ...
      $("#div_show_notification_form").show();
    	...
    	load_form("show_notification",function(){
