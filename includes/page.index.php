<section id="main-slider">
    <div class="owl-carousel">
        <div class="item" style="background-image: url(images/slides/bg1.jpg);background-position: 50% 0;background-size: cover;height:500px;">
...
<!-- <section id="animated-number">
  <div class="container">
      <div class="section-header">
          <h2 class="section-title text-center wow fadeInDown animated" style="visibility: visible; animation-name: fadeInDown;">Mon Compte</h2>
      </div>
        <div class="contact-form">
          <form id="login-form" name="login-form" method="post" action="#">
            ...
            <div class="form-group">
            <input type="password" name="password" id="password" class="form-control" placeholder="Mot de pass" >
            </div>

            <button type="submit" class="btn btn-success btn-lg">Se connecter</button> ou
            <a href="javascript:;" data-toggle="modal" data-target="#myModal" class="btn btn-success btn-lg">Créer un compte</a><br>
            <a href="./?page=lost_password"  class="btn btn-secondary">Mot de passe oublié?</a>
          </form>
        </div>
  </div>
</section> -->
