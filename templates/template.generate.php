			...
			<div class="content_box">
				<div id="tab01" class="content default_tab">
					...
					<br class="clear" />
							    ...
							    Besoin de description de tous champ utilis&egrave; s'il vous pla&icirc;t <a href="<?=$data['Members']?>/paiments-Edinars#ipn">CLIQUEZ ICI</a>
								<br><br>
							...
							<form id="code-form" action="">	
								<textarea readonly ><?=$post['PostHtmlCode']?></textarea>
									...
									<h2>EXEMPLE</h2>
									POST :<br>  <br><?=unhtmlentities($post['OrgPostHtml'])?>
									<br>
					...
					<br class="clear" />
						...
						<form id="code-form" action="">
								...
								<br><br>
								 Copiez ce code et coller dans votre page
								<br><br>
								<textarea readonly ><?=$post['GetHtmlCode']?></textarea>
							</form>
							
							  <center>
									<h2>EXEMPLE</h2>

									 <div>GET :  <br><br><?=unhtmlentities($post['OrgGetHtml'])?></div>
									<br>
							    </center>
							</form>	
					</center>	
