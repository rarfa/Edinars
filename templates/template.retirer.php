            ...
            <?}elseif($post['step']==2){?>
                        ...
                        <? if(($post['wtype']=='cheque') || ($post['wtype']=='ccp')){?>
                            ...
                            <table class="common_table_detail">
                                <thead>
                                    <tr>
                                        <th class="code_col" colspan=2>LES INFORMATIONS DE RETIRER PAR <?php echo strtoupper($post['wtype'])?></th>
                                    </tr>
                                </thead>
                                <tbody>
                                        <tr>
                ...
                <table class="common_table_detail">
                                <thead>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <b>Votre demande de retirer le transfert a �t� envoy�.
                                                <br>Vous devriez recevoir une notification par e-mail au sujet de cette transaction.    
                                                <br>Cette transaction sera trait�e dans les 24 heures.
                                                <br>S'il vous pla�t �tre patient
                                        </b>
                                            </td>
                                        </tr>
