                   ...
                   <ul class="list1">
                    <?    $qr1 = mysql_query("SELECT * FROM dp_faq_cat_list ORDER BY title") or die( mysql_error() );
                        ...
                        if (!$r1->title) continue;
                            ?>
                                <li><a href="#<?php echo $r1->id?>"><?php echo $r1->title?></a></li>
                            <?
                                }
                            ?>
                    </ul>
            ...
            <div class="col_text">
                    ...
                    <?    $qr1 = mysql_query("SELECT * FROM dp_faq_cat_list ORDER BY title ") or die( mysql_error() );
                                  while ($r1 = mysql_fetch_object($qr1)){
                                    if (!$r1->id) continue;
                                    ?>
                                        <h1 id="<?php echo $r1->id?>"><?php echo $r1->title?></h1>
                                    ...
                                    ?>                
                                            <li><a href="#<?php echo $r2->id?>_<?php echo $r1->id?>"><?php echo $r2->question?></a></li>
                                    <?    } ?>
                                        </ul>
                                        <dl class="faq">
                                    <?        
                                    ...
                                    ?>                
                                            <dt id="<?php echo $r3->id?>_<?php echo $r1->id?>"><?php echo $r3->question?></dt>
                                            <dd><?php echo $r3->answer?></dd>
                                    <?    } ?>
                                        </dl>
                                    <?
                                    }  
