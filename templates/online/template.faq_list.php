...
?>
<tr><td class=input><?php echo ($a->id ? "<input type=radio name=delete value=$a->id>" : "&nbsp;")?></td><td class=input><?php echo $a->id?></td><td class=input><TABLE cellspacing=0>
            <TR>
                <TD valign=top><b>Q: </TD>
                <TD valign=top>
                    <input type=text name=question<?php echo $a->id?> size=60 value="<?php echo htmlspecialchars($a->question)?>">
                </TD>
            </TR>
            <TR>
                <TD valign=top><b>A: </TD>
                <TD valign=top>
                    <textarea name="answer<?php echo $a->id?>" cols=60 rows=5><?php echo htmlspecialchars($a->answer)?></textarea>
                </TD>
            </TR>
            </table></td><td class=input><select name="cat<?php echo $a->id?>">
<?
        // Selection Header
...
<tr><th colspan=4><input type=submit name=change_list value="UPDATE FAQS">
            <input type=submit name=change_list value="DELETE SELECTED" <?php echo $del_confirm?>></th></tr>
