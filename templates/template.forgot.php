...
<?if(isset($data['ScriptLoaded'])){?>
                                    ...
                                    <table id="hor-minimalist-a" summary="MOT-DE-PASS">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><input type="text" id="email" name="email" size="30" maxlength="250" value="<?php echo prntext($post['email'])?>" class="validate[required,custom[email]] text-input"></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    </p>    
                                    ...
                                    <table id="hor-minimalist-a" summary="MOT-DE-PASS">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><b><?php echo $data['question'][$post['question']] ?></b></td>
                                            </tr>
                                            <tr>
                                                <td align="right">R&egrave;ponse de s&egrave;curit&egrave; (*):</td>
                                                <td><input type="text" id="answer" name="answer" size="30" maxlength="250" value="<?php echo prntext($post['answer'])?>" class="validate[required] text-input">            </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    </p>    
    ...
    <?}elseif($post['step']==4){?>
                        <article class="col-2">
                            ...
                            <div class="col_text">
                                <p class="pm">
                                        Vous avez modifi� le mot de passe de votre compte avec succes.
                                    </p>
                                    
                                    <p class="pm">
                                        Si vous n'avez pas demand� de modifier votre mot passe, veuillez contacter le service client imidiatement.</p>
                                    </p>
