        ...
        <div class="admin_box">
            ...
            <div class="admin_box_header">
                <div class="box_header_left">
                    ...
                    <a href="#tab01" class="default_tab current" onclick="jQuery('#ccp-form').validationEngine('hide');"><span class="tab">DEPOSER PAR CARTE DE RECHARGE</span><span class="tab_right"></span></a>
                    <a href="#tab02" onclick="jQuery('#topup-form').validationEngine('hide');"  ><span class="tab">DEPOSER PAR CCP</span><span class="tab_right"></span></a>
