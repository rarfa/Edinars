			...
			<div class="admin_box_header">
				<div class="box_header_left">
					<div class="header_tabs"><!-- add tabs in this div -->
						...
						<a href="#tab02" ><span class="tab">Informations compl&eacute;mentaires</span><span class="tab_right"></span></a>
					</div>
				</div>                
			</div>
				...
				<div id="tab01" class="content default_tab">
					...
					<br class="clear" />
								<form id="contacts-form" >
									...
									<textarea readonly ><?=$post['HtmlCode']?></textarea>
									<br><br>
								</form>	
					...
					<table class="common_table">
						<thead>
							...
							<tbody>
								...
								<tr>
									<td>refrence</td>
									<td>syst&egrave;me, URL de r&eacute;f&eacute;rence (<?=$data['Host']?>) </td>
								</tr>
								<tr>
