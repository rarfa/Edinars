                    ...
                    <div class="admin_box_header">
                        <div class="box_header_left">
                            <div class="header_tabs"><!-- add tabs in this div -->
                                ...
                                <a href="<?php echo $data['Members']?>/mes-emails-Edinars/ajouter" class="no_submenu" ><span class="tab">Ajouter Email</span><span class="tab_right"></span></a>
                            </div>
                        </div>                
                    </div>
            ...
            <?if($data['Error']){?>
                ...
                <div class="admin_box">
                    ...
                    <div class="admin_box_header">
                        <div class="box_header_left">
                            <div class="header_tabs"><!-- add tabs in this div -->
                                <a href="<?php echo $data['Members']?>/mes-emails-Edinars/"  class="no_submenu"  onclick="jQuery('#sigup-form-step1').validationEngine('hide');jQuery('#sigup-form-step2').validationEngine('hide');jQuery('#sigup-form-step3').validationEngine('hide')<?php if($post['type'] == 1) {?> ;jQuery('#sigup-form-step4').validationEngine('hide')<?php 
                                         } ?> " ><span class="tab">G&egrave;rer&nbsp;Emails</span><span class="tab_right"></span></a>
                                <a href="<?php echo $data['Members']?>/mes-emails-Edinars/ajouter" class="default_tab current" ><span class="tab">Ajouter Email</span><span class="tab_right"></span></a>
