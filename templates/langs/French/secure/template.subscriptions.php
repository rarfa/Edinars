            ...
            <div class="admin_box_header">
                <div class="box_header_left">
                    <div class="header_tabs"><!-- add tabs in this div -->
                        ...
                        <a href="<?php echo $data['Members']?>/subscriptions-Edinars.html/ajouter" class="no_submenu"><span class="tab">Ajouter un Abonnements</span><span class="tab_right"></span></a>
                    ...
                    <table class="common_table">
                        ...
                        <?$idx=0;foreach($data['Products'] as $value){ ?>
                            <tr>
                                ...
                                <td nowrap>
                                    <a href="<?php echo $data['Members']?>/subscriptions-Edinars.html/<?php echo $value['id']?>/update"><img src="<?php echo $data['Host']?>/images/icons/edit.png"  alt="MODIFIER"></a> 
                                    <a href="<?php echo $data['Members']?>/subscriptions-Edinars.html/<?php echo $value['id']?>/supprimer" onclick="return cfmform()"><img src="<?php echo $data['Host']?>/images/icons/delete.png"  alt="SUPPRIMER"></a>
                                    <a href="<?php echo $data['Members']?>/code-Edinars.html/<?php echo $value['id']?>/subscriptions"><img src="<?php echo $data['Host']?>/images/icons/code.png"  alt="G&Eacute;N&Eacute;RER CODE"></a>
                                </td>
                            </tr>
                        <?$idx++;}?>
                         </tbody>
                        ...
                        <table class ="common_table">
                                    ...
                                    <?$idx=0;foreach($data['Subscriptions'] as $value){ ?>
                                        <tr >
                                            ...
                                            <td><a href="<?php echo $data['Members']?>/subscriptions-Edinars.html/<?php echo $value['id']?>/annuler" onclick="return cfmform()"><img src="../images/icons/delete.png"  alt="ANNULER"> </a></td>
                                        </tr>
                                    <?$idx++;}?>
                                    </tbody>
                                </table>
    ...
    <?php  } else  { ?>                            
        ...
        <div class="admin_box">
            ...
            <div class="admin_box_header">
                <div class="box_header_left">
                    <div class="header_tabs"><!-- add tabs in this div -->
                        <a href="<?php echo $data['Members']?>/subscriptions-Edinars.html" class="no_submenu" ><span class="tab">Les Abonnements</span><span class="tab_right"></span></a>
                        <?if($post['gid']){?>
