				...
				<p class="pm">
					...
					<?if(!$data['PostSent']){?>
						<form method="post" id="sigup-form">
							...
							<input type="hidden" id="newtype" name="newtype" value="<?=prntext($post['newtype'])?>">
							<p class="pm">
								<?if($data['Error']){?>
							...
							<table id="hor-minimalist-a" summary="PROFILE">
													...
													<tr>
														<td>Identifiant (*) :</td>
														<td><input type="text" id="newuser" name="newuser" size="35" maxlength="50" value="<?=prntext($post['newuser'])?>" class="validate[required] text-input"></td>
													</tr>
													<tr>
														<td>E-Mail Adresse (*):</td>
														<td><input type="text" id="newmail" name="newmail" size="35" maxlength="50" value="<?=prntext($post['newmail'])?>" class="validate[required,custom[email]] text-input"></td>
													</tr>
													<tr>
													...
													<tr>
														...
														<td><select name="newques" id="newques" class="validate[required]">
														  <?=showselect($data['question'], $post['newques'])?>
														</select>
														</td>
														<td></td>	
													</tr>
													<tr>
														...
														<td><input type="text" id="newansw" name="newansw" size="35" maxlength="100" value="<?=prntext($post['newansw'])?>" class="validate[required] text-input"></td>
													</tr>
													...
													OUI, J'ai lu les
													<a href="conditions-utilisation-Edinars.html" target="new">Termes et Conditions</a>
					...
					<?}else{?>
						<br>
							<p class="pm">
								Un message a &egrave;t&egrave; envoy&egrave; &egrave; l'adresse e-mail <?=prntext($post['newmail'])?><br>
