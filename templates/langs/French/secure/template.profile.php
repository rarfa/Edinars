...
<!-- ############# admin_box start ############# -->
		<div class="admin_box">
			...
			<div class="admin_box_header">
				...
				<a href="#tab01" class="default_tab current" onclick="jQuery('#sigup-form-step1').validationEngine('hide');jQuery('#sigup-form-step2').validationEngine('hide');jQuery('#sigup-form-step3').validationEngine('hide')<?php if($post['type'] == 1){?> ;jQuery('#sigup-form-step4').validationEngine('hide')<?php } ?> " ><span class="tab">Mon Profile</span><span class="tab_right"></span></a>
				<a href="#tab02" onclick="jQuery('#sigup-form-step1').validationEngine('hide');jQuery('#sigup-form-step2').validationEngine('hide');jQuery('#sigup-form-step3').validationEngine('hide')<?php if($post['type'] == 1){?> ;jQuery('#sigup-form-step4').validationEngine('hide')<?php } ?>"><span class="tab">Mon Address</span><span class="tab_right"></span></a>
				<?php if($post['type'] == 1){?>
			...
			<div class="content_box">
					  ...
					  <form method="post"  action="" id="sigup-form-step1" >
						<table class="common_table_detail">
							...
							<tbody>
								<tr>
									<td>Mon Status</td>
									<td><font color=<?if($post['status']<2){?>#FF0000<?}else{?>#0066CC<?}?>><?=prntext($data['MemberStatus'][$post['status']]['status'])?></font>
									</td>
								</tr>
								<tr>
									<td>Identifiant</td>
								...
								<tr>
									<td>Nom (*)</td>
									<?if($data['InfoIsProfileEmpty']){?>
										<td><input type="text" name="fname" id="fname" size="41" maxlength="32" value="<?=prntext($post['fname'])?>" class="validate[required] text-input"></td>
									<? } else { ?>
								...
								<tr>
									<td>Pr&egrave;nom (*)</td>
									<?if($data['InfoIsProfileEmpty']){?>
										<td><input type="text" name="lname" id="lname" size="41" maxlength="32" value="<?=prntext($post['lname'])?>" class="validate[required] text-input"></td>
									<? } else { ?>
								...
								<tr>
									...
									<?if($data['InfoIsProfileEmpty']){?>
										<td><select name="type" id="type" class="validate[required]">
														  <?=showselect($data['MemberType'], $post['type'])?>
														</select>
										</td>
									<? } else { ?>
										<td>	<?=$data['MemberType'][$post['type']] ?></td>
									<? } ?>
								</tr>
								<tr>
									<td>T&egrave;l&egrave;phone</td>
									<td><input type="text" name="phone" size="41" maxlength="64" value="<?=prntext($post['phone'])?>"></td>
								</tr>
								<tr>
									<td>Mobile (*)</td>
									<td><input type="text" name="mobile"  id="mobile" size="41" maxlength="64" value="<?=prntext($post['mobile'])?>" class="validate[required,custom[phone]] text-input"></td>
								</tr>
								<tr>
									<td>Fax</td>
									<td><input type="text" name="fax" size="41" maxlength="64" value="<?=prntext($post['fax'])?>"></td>
								</tr>
								<tr>
				...
				<div id="tab02" class="content">
						...
						<tbody>
							<tr>
										<td>Address (*):</td>
										<td><input type="text" name="address"  id="address" size="41" maxlength="128" value="<?=prntext($post['address'])?>" class="validate[required] text-input"></td>
									</tr>
									<tr>
										<td>Commune (*):</td>
										<td><input type="text" name="city" id="city" size="41" maxlength="64" value="<?=prntext($post['city'])?>" class="validate[required] text-input"></td>
									</tr>
									<tr>
										<td>Code postal (*):</td>
										<td><input type="text" name="postcode" id="postcode" size="41" maxlength="64" value="<?=prntext($post['postcode'])?>" class="validate[required] text-input"></td>
									</tr>
									<tr>
										<td>Wilaya(*):</td>
							...
							<table class="common_table_detail">
								...
								<tbody>
									<tr>
												...
												<td><input type="text" name="company" id="company"  size="41" maxlength="128" value="<?=prntext($post['company'])?>" class="validate[required] text-input"></td>
											</tr>
											<tr>
												<td>N&deg; RC (*) :</td>
												<td><input type="text" name="nrc"  id="nrc" size="41" maxlength="128" value="<?=prntext($post['nrc'])?>" class="validate[required] text-input"></td>
											</tr>
											<tr>
												<td>N&deg; NIF (*) :</td>
												<td><input type="text" name="nnif" id="nnif" size="41" maxlength="128" value="<?=prntext($post['nnif'])?>" class="validate[required] text-input"></td>
											</tr>
											<tr>
												<td>N&deg; ART (*) :</td>
												<td><input type="text" name="nart" id="nart" size="41" maxlength="128" value="<?=prntext($post['nart'])?>" class="validate[required] text-input"></td>
											</tr>
											<tr>
												<td>N&deg; FIS :</td>
												<td><input type="text" name="nfis" size="41" maxlength="128" value="<?=prntext($post['nfis'])?>"></td>
											</tr>
											<tr>
												<td>Logo </td>
												<td>
