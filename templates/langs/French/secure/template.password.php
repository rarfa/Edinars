                        ...
                        <table class="common_table_detail">
                            ...
                            <tbody>
                                    <tr>    
                                        ...
                                        <td><input type="password" id="opass" name="opass" size="30" maxlength="100" value="<?php echo prntext($post['opass'])?>" class="validate[required,optional,minSize[9]] text-input"></td>
                                    </tr>
                                    <tr>    
                                        <td>Nouveau mot de passe (*):</td>
                                        <td><input type="password" id="npass" name="npass" size="30" maxlength="100" value="<?php echo prntext($post['npass'])?>" class="validate[required,optional,minSize[9]] text-input" ></td>
                                    </tr>
                                    <tr>    
                                        <td>Re-enter Nouveau mot de passe (*):</td>
                                        <td><input type="password" id="cpass" name="cpass" size="30" maxlength="100" value="<?php echo prntext($post['cpass'])?>" class="validate[required,minSize[9],equals[npass]] text-input"></td>
                                    </tr>                                    
                                    <tr>
                ...
                <div id="tab02" class="content">
                        ...
                        <tbody>
                                <tr>
                                    ...
                                    <td>
                                    <select name="question" id="question" class="validate[required]" ><?php echo showselect($data['question'], $post['question'])?></select>
                                    </td>
                                </tr>
                                <tr>
