                ...
                <div id="tab01" class="content default_tab">
                    ...
                    <center>
                        ...
                        <table CLASS="common_table_detail">
                                <tr>
                                    <th class="code_col"  colspan=2 ><b>FRAIS D&Egrave;P&Ocirc;T PAR CARTE DE RECHARGE: <?php echo prnsumm($data['DepositMethod']['topup']['prcn'])?>%</b></th>
                                    <th></th>
                                </tr>
                            </thead>
                            <tbody>
                    ...
                    <br class="clear" />
                        <center>
                         <form method="post"  id="ccp-form" >
                            ...
                            <thead>
                                <tr>
                                    <th class="code_col"  colspan=2><b>FRAIS D&Egrave;P&Ocirc;T PAR VIREMENT BANCAIRE: <?php echo prnsumm($data['DepositMethod']['CCP']['prcn'])?>% &nbsp;+&nbsp; <?php echo prnsumm($data['DepositMethod']['CCP']['fees'])?>&nbsp;<?php echo prntext($data['Currency'])?></b></th>
                                </tr>
                            </thead>
                            <tbody>
