                ...
                <?if(!$data['PostSent']){?>    
                            ...
                            <div class="left"> 
                                <div class="right">
                                    ...
                                    <tr>
                                        <td>Nom (*) :</td>
                                        <td><input type="text"  id="nom" name="nom" size="35" maxlength="50" value="<?php echo prntext($post['nom'])?>" class="validate[required] text-input"></td>
                                    </tr>
                                    <tr>
                                        <td>E-Mail Adresse (*):</td>
                                        <td><input type="text" id="mail" name="mail" size="35" maxlength="50" value="<?php echo prntext($post['mail'])?>" class="validate[required,custom[email]] text-input"></td>
                                    </tr>
                                    <tr>
                                        <td>Telephone (*):</td>
                                        <td><input type="text" id="phone" name="phone" size="35" maxlength="50" value="<?php echo prntext($post['phone'])?>" class="validate[required,custom[phone]] text-input" ></td>
                                    </tr>
                                    <tr>
                                        <td>Message (*):</td>
