...
<?if(isset($data['ScriptLoaded'])){?>
	<?if(!$post['PostSent']){?>
		<form method="post" name="data" id="sigup-form" > 
			<input type="text" name=step value="<?=$post['step']?>">
		<center>
					...
					<br>
						<div class="field text">
								<label>Bare code :</label>
								 <input type=text name="barecode" size=3 maxlength=3 value="<?=prntext($post['barecode'])?>">
						</div>
						<div class="field text">
								<label>Wilaya:</label>
								 <input type=text name="wilayacode" size=2 maxlength=2 value="<?=prntext($post['wilayacode'])?>">
						</div>
							<div class="field text">
								<label> Quantit&egrave;:</label>
								 <input type=text name="qty" size=2 maxlength=5 value="<?=prntext($post['qty'])?>">
						</div>
						<div class="field text">
								<label> Montant:</label>
								 <input type=text name="montant" size=2 maxlength=16 value="<?=prntext($post['montant'])?>">
						</div>
					</div>
