			...
			<div class="content_box">
				...
				<div id="tab02" class="content">
					<br class="clear" />
						...
						<table CLASS="common_table_detail">
								<tr>
									<th class="code_col"  colspan=2 ><b>FRAIS D&Egrave;P&Ocirc;T CARTE DE RECHARGE: <?=prnsumm($data['DepositMethod']['topup']['prcn'])?>% &nbsp;+&nbsp; <?=prnsumm($data['DepositMethod']['topup']['fees'])?>&nbsp;<?=prntext($data['Currency'])?></b></th>
									<th></th> 
								</tr>
							</thead>
							<tbody>
		...
		<table class="common_table_detail" >
			...
			<tbody>
					...
					<?if($post['dtype']=='CCP'){?>
							...
							<tr>	
								<td colspan=2 >
									<b>S'il vous pla&icirc;t envoyer un paiement de <?=prnpays($post['total'])?> &agrave; le compte suivante</b>
								</td>
							</tr>
							<tr>
								<td colspan=2 >
