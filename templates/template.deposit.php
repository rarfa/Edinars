            ...
            <div class="admin_box_header">
                <div class="box_header_left">
                    <div class="header_tabs"><!-- add tabs in this div -->
                        <a href="#tab01" class="default_tab current" ><span class="tab">DEPOSER PAR CCP</span><span class="tab_right"></span></a>
                        <a href="#tab02" ><span class="tab">DEPOSER PAR CARTE DE RECHARGE</span><span class="tab_right"></span></a>
                    </div>
                </div>                
            </div>
            ...
            <div class="content_box">
                <div id="tab01" class="content default_tab">
                    ...
                    <center>
                        ...
                        <table class="common_table_detail" >
                            <thead>
                                <tr>
                                    <th class="code_col"  colspan=2><b>FRAIS D&Egrave;P&Ocirc;T PAR CCP: <?php echo prnsumm($data['DepositMethod']['CCP']['prcn'])?>% &nbsp;+&nbsp; <?php echo prnsumm($data['DepositMethod']['CCP']['fees'])?>&nbsp;<?php echo prntext($data['Currency'])?></b></th>
                                </tr>
                            </thead>
                            <tbody>
                                <?if (!$post['ShowCheckInfo']) {?>
                                    ...
                                    <tr>
                                        <td colspan="2" class="middle">
                                            <?if (!$post['ShowCheckInfo']) {?>
                                                <input type="submit" id="submit" name="send" value="D&egrave;P&ocirc;T MAINTENANT" />
                                            <? } ?>
                                        </td>
                                    </tr>                                    
                ...
                <div id="tab02" class="content">
                    <br class="clear" />
                        ...
                        <table CLASS="common_table_detail">
                                <tr>
                                    <th class="code_col"  colspan=2 ><b>FRAIS D&Egrave;P&Ocirc;T CARTE DE RECHARGE: <?php echo prnsumm($data['DepositMethod']['topup']['prcn'])?>% &nbsp;+&nbsp; <?php echo prnsumm($data['DepositMethod']['topup']['fees'])?>&nbsp;<?php echo prntext($data['Currency'])?></b></th>
                                    <th></th> 
                                </tr>
                            </thead>
                            <tbody>
                                    ...
                                    <tr> 
                                            ...
                                            <br>
                                            <td>Montant &agrave; D&egrave;poser :</td>
                                            <td><input type="text" name="montant-topup" id="montant-topup" maxlength=16 value="<?php echo prntext($post['montant'])?>" class="validate[required,custom[number]]  text-input"></td>
                                    </tr> 
                                    <tr>
                                            <td>Saisissez les chifres: </td>
                                            <td><input type="text" name="topup_number" id="topup_number" value="<?php echo $post['topup_number']?>"  maxlength="16" class="validate[required]  text-input"></td>
                                    </tr>        
                                    <?php }else {?>
                                    <tr>
                                        <td colspan=2>
                                                La carte de recharge a  &egrave;t&egrave; charger avec succ&egrave;s votre Solde: <?php echo prnpays($data['Balance']) ?>
                                        </td>        
                                    </tr>
                                        <tr> 
                                            <td>Montant</td>
                                    ...
                                    <?if (!$post['ShowCheckInfo']) {?>
                                        <tr>
                                            <td class="middle" COLSPAN="2"><input type="submit" id="submit" name="send" value="D&egrave;P&ocirc;T MAINTENANT" /></td>
                                        </tr>
                                    <? } ?>
                            </tbody>
                        </table>
        ...
        <table class="common_table_detail" >
            ...
            <tbody>
                    ...
                    <?if($post['dtype']=='CCP'){?>
                            ...
                            <tr>    
                                <td colspan=2 >
                                    <b>S'il vous pla&icirc;t envoyer un paiement de <?php echo prnpays($post['total'])?> &agrave; le compte suivante</b>
                                </td>
                            </tr>
                            <tr>
                                <td colspan=2 >
                            ...
                            <tr>
                                <td colspan=2 class="middle">
                                    <FORM METHOD="POST">
                                        <input type="submit" id="submit" name="cancel" value="<?if($post['dtype']=='CCP'){?>Termin&egrave;<?}elseif ($post['ShowCheckInfo']){ ?>Termin&egrave;<?} else{?>ANULLER TRANSACTION<?}?>" />            
                                    </FORM>
                                </td>
                            </tr>
                     <?}else{?>
