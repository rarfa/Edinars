            ...
            <div class="admin_box_header">
                <div class="box_header_left">
                    <div class="header_tabs"><!-- add tabs in this div -->
                        ...
                        <a href="<?php echo $data['Members']?>/donations-Edinars/ajouter" class="no_submenu"><span class="tab">Ajouter des Donations</span><span class="tab_right"></span></a>
                    </div>
                </div>                
            </div>
                    ...
                    <table class="common_table">
                        ...
                        <?$idx=0;foreach($data['Products'] as $value){  ?>
                            <tr>
                                ...
                                <td nowrap>
                                    <a href="<?php echo $data['Members']?>/donations-Edinars/<?php echo $value['id']?>/update"><img src="<?php echo $data['Host']?>/images/icons/edit.png"  alt="MODIFIER"></a> 
                                    <a href="<?php echo $data['Members']?>/donations-Edinars/<?php echo $value['id']?>/supprimer" onclick="return cfmform()"><img src="<?php echo $data['Host']?>/images/icons/delete.png"  alt="SUPPRIMER"></a>
                                    <a href="<?php echo $data['Members']?>/code-Edinars/<?php echo $value['id']?>/donation"><img src="<?php echo $data['Host']?>/images/icons/code.png"  alt="G&Eacute;N&Eacute;RER CODE"></a>
                                </td>
                            </tr>
                        <?$idx++;}?>
                    </tbody>
    ...
    <?php  } else  { ?>                            
        ...
        <div class="admin_box">
            ...
            <div class="admin_box_header">
                <div class="box_header_left">
                    <div class="header_tabs"><!-- add tabs in this div -->
                        <a href="<?php echo $data['Members']?>/donations-Edinars" class="no_submenu" ><span class="tab">Tous Les Produits/Serivces</span><span class="tab_right"></span></a>
                        <?if($post['gid']){?>
